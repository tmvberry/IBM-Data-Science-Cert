...
def update_output_container(selected_satistics, input_year):
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
          figure=px.bar(average_sales, x='Vehicle_Type', y='average_sales',
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            ...
            Title = "Share of Advertising Expenditures by Vehicle Type During Recessions")
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
            ...
            # Plot 4otal Advertisement Expenditure for each vehicle using pie chart
        exp_data=yearly_data.groupby('Vehicle_Type'),['Advertising_Expenditure'].sum().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, 
                                            values='Advertising_Expenditure',
                                             names='Vehicle_Type',
title='Adversiting Expenditures per year, by Vehicle Type'))
